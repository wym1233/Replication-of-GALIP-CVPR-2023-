...
def load_clip(clip_info, device):
    ...
    model = clip.load('/data/wym123/24RSP_GALIP/pretrainckpts/ViT-B-32.pt', device=device)[0]
...
def prepare_models(args):
    ...
    NetG,NetD,NetC,CLIP_IMG_ENCODER,CLIP_TXT_ENCODER = choose_model(args.model)#1--------------------------------------------------------
    # image encoder
